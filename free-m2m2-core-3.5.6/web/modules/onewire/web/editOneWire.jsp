...
<script type="text/javascript">
  ...
  function getNetworkInfoCB(result) {
      ...
      //Removed as no longer in UI: cancelEditPoint();
  }
  ...
  function attributeIdChanged() {
      ...
      switch(attributeId){
      case <%= OneWirePointLocatorVO.AttributeTypes.LATCH_STATE %>:
      	dataPointDataTypeChanged(<%= DataTypes.BINARY %>);
      break;
      case <%= OneWirePointLocatorVO.AttributeTypes.WIPER_POSITION %>:
