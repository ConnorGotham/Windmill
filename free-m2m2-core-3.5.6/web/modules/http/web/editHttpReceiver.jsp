...
<%@page import="com.serotonin.m2m2.http.vo.HttpReceiverDataSourceVO"%>
...
<script type="text/javascript">
  ...
  function saveDataSourceImpl(basic) {
      ...
      HttpDataSourceDwr.saveHttpReceiverDataSource(basic, ipWhiteList, deviceIdWhiteList, $get("setPointUrl"), 
              $get("setType"), $get("dateFormat"), saveDataSourceCB);
  }
  ...
  function httpListenUpdate() {
	  HttpDataSourceDwr.httpParameterReceiverListenerUpdate(function(result) {
          if (result) {
  ...
  function editPointCBImpl(locator) {
      ...
      $set("includeTimestamp", locator.includeTimestamp);
  ...
  function savePointImpl(locator) {
      ...
      locator.includeTimestamp = $get("includeTimestamp");
...
<tag:dataSourceAttrs descriptionKey="dsEdit.httpReceiver.desc" helpId="httpReceiverDS">
  ...
  <jsp:body>
    ...
    <tr>
      <td class="formLabel"><fmt:message key="dsEdit.httpReceiver.setFormat"/></td>
      <td class="formField">
        <tag:exportCodesOptions id="setType" value="${dataSource.setType}" optionList="<%= HttpReceiverDataSourceVO.SET_TYPE_CODES.getIdKeys() %>"/>
      </td>
    </tr>
    
    <tr>
      <td class="formLabel"><fmt:message key="publisherEdit.httpSender.dateFormat"/></td>
      <td class="formField">
        <sst:select id="dateFormat" value="${dataSource.dateFormat}">
...
<tag:pointList pointHelpId="httpReceiverPP">
  ...
  <tr>
    <td class="formLabel"><fmt:message key="publisherEdit.httpSender.point.timestamp"/></td>
    <td class="formField"><input type="checkbox" id="includeTimestamp"/></td>
  </tr>
</tag:pointList>